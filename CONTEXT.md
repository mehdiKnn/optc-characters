...
- **Équipe PVE** : 2 capitaines (dont un friend captain choisi dans toute la base) + 4 membres + supports + bateau (affiché, effets non simulés). Au plus 1 support par personnage possédé (capitaine et 4 membres) — soit 5 supports max ; le friend captain n'en reçoit jamais et n'a pas besoin d'être possédé.
